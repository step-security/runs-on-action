...
func TestCurrentGitProxyPolicy(t *testing.T) {
	t.Setenv("GITHUB_REPOSITORY", "Step-Security/Runs-On-Action")
	...
	if policy.allRefs || policy.repository != "step-security/runs-on-action" || policy.ref != strings.Repeat("a", 40) {
